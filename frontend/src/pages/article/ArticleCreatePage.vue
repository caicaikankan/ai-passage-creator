          ...
          <div class="input-card">
            ...
            <div class="input-area">
              ...
              <div class="word-count-section">
                <div class="section-header">
                  <span class="section-title">文章字数</span>
                  <span class="section-tip">（选择AI生成文章的目标字数）</span>
                </div>
                <a-select
                  v-model:value="wordCount"
                  class="word-count-select"
                  placeholder="请选择字数"
                >
                  <a-select-option :value="1000">短篇（约1000字）</a-select-option>
                  <a-select-option :value="2000">中篇（约2000字）</a-select-option>
                  <a-select-option :value="5000">长篇（约5000字）</a-select-option>
                  <a-select-option :value="8000">超长篇（8000字+）</a-select-option>
                </a-select>
              </div>
...
const wordCount = ref<number | null>(null)  // 目标字数
...
.progress-tip {
  ...
  &.waiting {
    background: rgba(101, 116, 139, 0.08);
    border-color: rgba(101, 116, 139, 0.2);
  }
}
